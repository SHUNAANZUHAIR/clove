...
const quickLogins: QuickLogin[] = [
  { id: 'clove_cafe', siteName: 'Clove Cafe & Bistro', brand: 'CLOVE CAFE', buttonLabel: 'Clove Cafe login', icon: Coffee },
  { id: 'clove_guesthouse', siteName: 'Clove Guesthouse', brand: 'CLOVE GUESTHOUSE', buttonLabel: 'Clove Guesthouse login', icon: Hotel },
];
      ...
      <div className="login-stack">
        ...
        {quickLogins.map((quickLogin) => (
          <section className="login-card quick-login-card" key={quickLogin.id}>
            <div className="login-brand"><span><quickLogin.icon size={25} /></span><div><p>{quickLogin.brand}</p><h1>Staff sign in</h1></div></div>
            {mode !== quickLogin.id ? (
              <>
