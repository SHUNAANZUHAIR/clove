    ...
    <>
      ...
      <main className="verify-page">
        <section className="verify-card">
          <div className={`verify-mark ${employee ? 'valid' : 'invalid'}`}>{employee ? '✓' : '!'}</div>
          <p className="eyebrow">CLOVE CAFE &amp; BISTRO</p>
          <h1>{employee ? 'Agreement verified' : 'Agreement not found'}</h1>
          {employee ? (
            <>
              <p className="lead">This employment agreement matches an active CloveHR employee record.</p>
              <dl>
